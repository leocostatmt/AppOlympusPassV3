...
class MinhaContaWidget extends StatefulWidget {
  const MinhaContaWidget({
    Key? key,
    String? planoAluno,
  })  : this.planoAluno = planoAluno ?? 'String',
        super(key: key);

  final String planoAluno;
                      ...
                      Column(
                        ...
                        children: [
                          ...
                          Padding(
                            ...
                            child: Text(
                              FFLocalizations.of(context).getText(
                                'xn9lw49v' /* Aqui estão seus dados e inform... */,
                              ),
                              style: FlutterFlowTheme.of(context)
                                  .labelMedium
                                  .override(
